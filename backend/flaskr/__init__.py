...
def create_app(test_config=None):
    ...
    def retrieve_categories():
        return jsonify({'categories': categories_items()})
    ...
    def retrieve_questions():
        ...
        current_questions = db.session.query(Question).order_by(Question.id).paginate(page=page,
        ...
        return jsonify({
            ...
            'currentCategory': random.choice(list(categories_items().values()))
        })
    ...
    def retrieve_by_category(id):
        ...
        if len(questions) != 0:
            data = {
                ...
                'current_category': random.choice(list(categories_items().values()))
            }
